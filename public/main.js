                ...
                if (!this._triggerSlideEvent(f, v).isDefaultPrevented())
                  if (a && f) {
                    ...
                    if (s.default(this._element).hasClass(B)) {
                      ...
                      if (p) {
                        var S =
                          parseFloat(t(this._element).attr('data-interval')) + w
            ...
            if (((ye = null), pe || ce || Se || oe)) {
              ...
              if ((te.calculateSwipeSpeed('x'), !oe)) {
                ...
                if ($e() < l.verticalDragRange) o.close()
                  ...
                  var p = w.y,
                    h = Oe
                  qt('verticalDrag', 0, 1, 300, n.easing.cubic.out, function (
                    t,
                  ) {
          ...
          di = function (e, i, a, s) {
            ...
            if (f && u && void 0 !== u.x) {
              ;(function () {
                var i = p,
                  s =
                    !o.currItem.src || o.currItem.loadError || l.showHideOpacity
                if (e.miniImg)
